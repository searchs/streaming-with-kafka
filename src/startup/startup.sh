...
kafka-topics --delete --zookeeper localhost:2181 --topic com.ohprice.shopping.users > startup/startup.log 2>&1
kafka-topics --delete --zookeeper localhost:2181 --topic com.ohprice.shopping.purchases > startup/startup.log 2>&1
kafka-topics --create --zookeeper localhost:2181 --topic com.ohprice.shopping.users --replication-factor 1 --partitions 10 > startup/startup.log 2>&1
kafka-topics --create --zookeeper localhost:2181 --topic com.ohprice.shopping.purchases --replication-factor 1 --partitions 10 > startup/startup.log 2>&1
kafka-topics --delete --zookeeper localhost:2181 --topic com.ohprice.shopping.pages > startup/startup.log 2>&1
kafka-topics --delete --zookeeper localhost:2181 --topic com.ohprice.shopping.clickevents > startup/startup.log 2>&1
kafka-topics --create --zookeeper localhost:2181 --topic com.ohprice.shopping.pages --replication-factor 1 --partitions 10 > startup/startup.log 2>&1
kafka-topics --create --zookeeper localhost:2181 --topic com.ohprice.shopping.clickevents --replication-factor 1 --partitions 10 > startup/startup.log 2>&1
